  ...
  void _deleteTanda(_TandaCard card) async {
    final confirmed = await showDialog<bool>(
      ...
      builder: (_) => AlertDialog(
        ...
        title: Text('Remover grupo', style: titleSemi(16)),
        content: Text(
      ...
      appBar: AppBar(
        ...
        title: Row(
          children: [
            ...
            Text('Mis Grupos', style: titleSemi(18, color: offWhite)),
          ],
        ),
      ),
      body: SafeArea(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Crea un nuevo grupo o únete a uno existente desde el panel principal.',
